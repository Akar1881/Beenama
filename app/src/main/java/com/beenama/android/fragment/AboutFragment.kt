...
import com.beenama.android.activity.UpdateActivity
import com.beenama.android.databinding.FragmentAboutBinding
...
class AboutFragment : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val installedVersion = com.beenama.android.helper.UpdateUtils.getInstalledVersionName(requireContext())

        if (com.beenama.android.helper.UpdateUtils.isNewVersionAvailable(installedVersion, latestVersion)) {
        ...
        binding.sourceCode.setOnClickListener {
            openUrl("https://github.com/Akar1881/MovieDB")
        }

        binding.reportIssue.setOnClickListener {
            openUrl("https://github.com/Akar1881/MovieDB/issues")
        }
        ...
        binding.shareIcon.setOnClickListener {
            val githubUrl = "https://play.google.com/store/apps/details?id=com.beenama.android.full"
