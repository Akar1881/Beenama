...
import com.beenama.android.databinding.FragmentDonationBinding
...
class DonationFragment : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        binding.libPayBtn.setOnClickListener {
            val url = "https://liberapay.com/Akar1881/donate"
            val intent = Intent(Intent.ACTION_VIEW, Uri.parse(url))
            startActivity(intent)
        }

        binding.githubSBtn.setOnClickListener {
            val url = "https://github.com/sponsors/Akar1881"
            val intent = Intent(Intent.ACTION_VIEW, Uri.parse(url))
            startActivity(intent)
        }

        binding.paypalBtn.setOnClickListener {
            val url = "https://paypal.me/Akar1881"
            val intent = Intent(Intent.ACTION_VIEW, Uri.parse(url))
            startActivity(intent)
        }

        binding.kofiBtn.setOnClickListener {
            val url = "https://ko-fi.com/beenama"
            val intent = Intent(Intent.ACTION_VIEW, Uri.parse(url))
            startActivity(intent)
        }
