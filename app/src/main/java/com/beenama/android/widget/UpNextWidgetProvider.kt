...
package com.beenama.android.widget
...
class UpNextWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_MARK_AS_WATCHED = "com.beenama.android.widget.action.MARK_AS_WATCHED"
        const val ACTION_REFRESH_UPNEXT = "com.beenama.android.widget.action.REFRESH_UPNEXT"
        const val EXTRA_SHOW_ID = "com.beenama.android.widget.extra.SHOW_ID"
        const val EXTRA_SEASON_NUMBER = "com.beenama.android.widget.extra.SEASON_NUMBER"
        const val EXTRA_EPISODE_NUMBER = "com.beenama.android.widget.extra.EPISODE_NUMBER"
    }
}
